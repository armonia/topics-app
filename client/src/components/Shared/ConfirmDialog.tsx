...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-body-lg leading-5 font-semibold text-app-text-heading mb-2">{title}</h3>
        <div className="text-compact leading-4 text-app-text-body mb-3">{children}</div>
        <div className="flex items-center justify-end gap-2">
          <button
            ref={cancelRef}
            onClick={onCancel}
            className="px-3 py-1.5 text-compact leading-4 rounded border border-app-border text-app-text-body hover:bg-app-hover transition-colors"
          >
            {cancelWord}
          </button>
          <button
            ...
            className={
              tone === 'danger'
                ? 'px-3 py-1.5 text-compact leading-4 rounded bg-red-600 text-white hover:bg-red-700 disabled:opacity-40 disabled:hover:bg-red-600 transition-colors'
                : 'px-3 py-1.5 text-compact leading-4 rounded bg-primary text-white hover:bg-primary-hover disabled:opacity-40 disabled:hover:bg-primary transition-colors'
            }
          >
            {confirmWord}
          </button>
