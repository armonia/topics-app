...
import { getPaneConfig, getTerminalSessionFromPaneId, isTerminalPaneId, isBrowserPaneId, pinKeyForPane, tabTargetForPane, type ProjectTabStatus, type PaneScope } from '../../state/pane/adapters';
