  ...
  return (
    <div data-testid="context-warnings" className="border-b border-app-border">
      ...
      >
        ...
        <span className="text-compact font-medium text-amber-600 dark:text-amber-400">
      ...
      {expanded && (
        <div className="px-4 pb-2 space-y-1">
          {warnings.map((w, i) => (
            <div key={i} className="flex items-start gap-2 text-mini text-app-text-secondary">
