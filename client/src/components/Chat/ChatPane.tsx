...
function ChatPaneComponent({
  ...
  }, [resizeImageToBase64, isGlobalOrchestrator]);
  ...
  return (
    ...
    >
      ...
      {!isGlobalOrchestrator && <ChangedFilesStrip key={topic.id} topicId={topic.id} projectPath={topic.projectPath} onWSMessage={onWSMessage} />}
