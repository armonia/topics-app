...
interface ToggleRowProps {
   ...
   *  exposed to assistive tech. It also dims the label, so the row reads as
   *  off. An `opacity-50 pointer-events-none` wrapper is NOT enough: the button
   *  stays focusable and still toggles from the keyboard, and `aria-checked`
   *  changes without ever saying it is disabled. */
  disabled?: boolean;
}
