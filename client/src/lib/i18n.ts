...
const IT: Dict = {
  ...
  'git.folderUntrackedIn': 'Non tracciata dal repo «{repo}» — ramo, remote e cronologia qui sotto sono suoi',
...
const EN: Dict = {
  ...
  'git.folderUntrackedIn': 'Not tracked by the «{repo}» repo — the branch, remotes and history below are its own',
