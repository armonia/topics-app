...
const IT: Dict = {
  ...
  'chat.queue.hide': 'Nascondi i messaggi da inviare',
  'chat.queue.show': 'Mostra i messaggi da inviare',
  'chat.queue.pending': 'da inviare',
  'chat.queue.whenTurnEnds': 'a fine turno',
  'chat.queue.title': 'Da inviare ({count})',
  'chat.queue.blurb': 'Partono quando il turno finisce. Fermare non li cancella: restano qui.',
  'chat.dictation.hint': '⌘⇧D per chiudere · Esc annulla',
  'chat.compactNow': 'Compatta adesso',
  'chat.newChat': 'Nuova chat',
  'chat.dismissNotice': "Chiudi l'avviso",
