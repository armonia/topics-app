...
const IT: Dict = {
  ...
  'board.gauge.fleetCores': 'flotta {ours} core su {budget}',
  'board.gauge.machineLoad': 'load macchina {load} su {cores} core',
  'board.gauge.freeMem': '{free} GB liberi su {total}',
  'board.gauge.spendToday': 'spesa nelle ultime 24h {amount}',
  'board.gauge.byResources': 'a risorse',
  'board.gauge.ariaResources': '{running} agent al lavoro, freno sulle risorse della macchina',
