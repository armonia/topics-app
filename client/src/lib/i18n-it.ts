...
const IT: Dict = {
  ...
  'ai.selector.ready': 'Pronto',
  'ai.selector.unavailableShort': 'Non disponibile',
  'ai.selector.unavailable': 'Questa esecuzione non è disponibile su questo server.',
  'ai.selector.noLongerAvailable': 'La scelta salvata non è più disponibile su questo server.',
  'ai.selector.openSettings': 'Apri impostazioni',
  'ai.selector.chooseModel': 'Scegli un modello compatibile',
  ...
  'app.archivedShort': 'archiviati',
  'app.panelsGroup': 'Pannelli',
  ...
  'update.detail.localShell': 'Guscio installato v{shell}',
  ...
  'guest.start.action': 'Avvia',
  'guest.start.queued': 'In coda. Si applica la politica del proprietario.',
  'guest.start.working': 'L’agente sta lavorando.',
  'guest.start.completed': 'Esecuzione completata.',
  'guest.start.cancelled': 'Esecuzione annullata.',
  'guest.start.failed': 'Non è stato possibile avviare l’agente. Verifica che l’autorizzazione sia ancora attiva e riprova.',
  'guest.start.policy': 'Esegue su {computer}',
  'guest.start.authorizedComputer': 'il computer autorizzato',
  ...
  'pair.requestsAccess': '{name} chiede accesso',
  'pair.deny': 'Nega',
  'pair.choosePerson': 'Scegli una persona esistente',
  'pair.createPerson': 'Crea una nuova persona',
  'pair.chooseExisting': 'Scegli una persona esistente',
  ...
  'ai.agents.hint': 'Codex può usare il tuo abbonamento ChatGPT per i task GPT. Gli agenti disponibili possono lavorare nei progetti; installazione e runtime si gestiscono nelle opzioni avanzate.',
  'ai.api.title': 'API per le chat',
  'ai.api.intro': 'Collega OpenAI per GPT o Anthropic per Claude. Poi scegli provider e modello dal composer della chat, oppure imposta un predefinito.',
  'ai.api.billing': 'Il consumo API è fatturato dal provider. Gli abbonamenti ChatGPT e Claude sono separati e non includono questo consumo.',
  'ai.api.chat': 'Chat via API, senza installare una CLI. Gli agenti che lavorano sui file richiedono un runtime compatibile.',
  'ai.status.ready': 'Connesso',
  ...
  'ai.api.connect': 'Verifica e collega',
  'ai.api.connecting': 'Verifica in corso…',
  'ai.api.storage': 'La chiave viene verificata e salvata sul server Topics, per questa installazione. La verifica legge il catalogo dei modelli e non genera risposte.',
  'ai.api.saved': 'Chiave verificata e salvata.',
  'ai.api.nextTurn': 'Vale dal prossimo turno.',
  'ai.api.keyRejected': 'Chiave API rifiutata. Controlla la chiave e i permessi del provider.',
  'ai.api.saveError': 'Non è stato possibile salvare la chiave.',
  'ai.local.title': 'Programmi locali',
  'ai.local.loadFailed': 'Impossibile leggere l’elenco dei programmi.',
  'ai.local.saveFailed': 'Impossibile salvare il percorso.',
  'ai.local.notFound': 'Non trovato',
  'ai.local.changePath': 'Cambia percorso',
  'ai.local.setPath': 'Imposta percorso',
  'ai.local.copied': 'Copiato',
  'ai.local.copy': 'Copia',
  'ai.local.missingPath': 'Il percorso impostato non esiste più: {path}',
  'ai.local.clearPath': 'Rimuovi',
  'ai.local.pathHint': 'Percorso completo del programma o della cartella che lo contiene. Per trovarlo, esegui {command} nel terminale.',
  'ai.execution.title': 'Esecuzione',
  'ai.local.hint': 'Programmi che Topics può usare per eseguire gli agenti. Se un programma installato manca, indica il suo percorso.',
  'ai.advanced.title': 'Esecuzione e programmi locali',
  ...
  'task.model.hint': 'Segue la scelta del progetto. In Auto, Topics sceglie tra i modelli collegati, disponibili e compatibili con il task, su tutti i provider. Puoi anche impostare un modello.',
  'task.model.sessionFixed': '{model}: il modello è fissato alla sessione già assegnata a questo task.',
  ...
  'topicBrowser.add': 'Nuova scheda',
  'topicBrowser.newSheet': 'Scheda vuota',
  'topicBrowser.openAsTab': 'Apri come tab',
  ...
  'browser.tab.downloadsCue': '{n} download in questa scheda',
  ...
  'browser.tab.sheet.title': 'Comandi della pagina',
  'browser.tab.sheet.address': 'Indirizzo',
  'browser.tab.sheet.recent': 'In questa scheda',
  'browser.tab.sheet.tools': 'Strumenti',
  'browser.tab.sheet.session': 'Sessione',
  'browser.tab.engine.playwright': 'Motore: Playwright',
  'browser.tab.engine.chromium': 'Motore: Chromium · {n} estensioni',
  'browser.tab.render.dom': 'Resa: DOM',
  'browser.tab.render.video': 'Resa: video',
  'browser.tab.kind.disconnected': 'Connessione persa: la pagina non si aggiorna',
  'browser.tab.kind.connecting': 'In collegamento alla sessione condivisa',
  ...
  'browser.tab.kind.heavy': 'Consumo alto: {cpu}% della CPU del Mac. Va in pausa quando lasci questa scheda',
  'browser.tab.kind.heavyPaused': 'In pausa per risparmiare CPU',
  'browser.heavy.paused.title': 'In pausa',
  'browser.heavy.paused.body': 'Questa pagina usava il {cpu}% della CPU del Mac. Riprende da dove era.',
  'browser.heavy.paused.bodyCpuMem': 'Questa pagina usava il {cpu}% della CPU e il {mem}% della memoria del Mac. Riprende da dove era.',
  'browser.heavy.paused.keepOnce': 'Mantieni per questa volta',
  'browser.heavy.paused.keepAlways': 'Mantieni sempre per questo sito',
  'browser.heavy.paused.resume': 'Riprendi',
  ...
  'checkpoint.blocked.turnInProgress': 'In questa chat un turno è ancora in corso: aspetta che finisca prima di tornare indietro.',
  'checkpoint.blocked.otherSession': 'Un\'altra chat ha scritto in questa cartella nel frattempo: tornare indietro disferebbe anche il suo lavoro.',
  ...
  'checkpoint.plan.nothing': 'Nessun file è cambiato da questo checkpoint: si muove solo la conversazione.',
  'checkpoint.plan.skipped': '{n} percorsi sono stati modificati da qualcun altro nel frattempo e restano com\'erano:',
  'checkpoint.plan.more': '+{n} altri',
  'checkpoint.plan.unknown': 'Il piano dei file non si è potuto leggere: cosa torna indietro lo decide il server alla conferma.',
  'checkpoint.rollback.refused': 'Ripristino rifiutato: {reason}',
  'checkpoint.rollback.title': 'Torna a questo checkpoint',
  'checkpoint.rollback.confirmTitle': 'Tornare a «{name}»?',
  'checkpoint.rollback.confirm': 'Torna indietro',
  'checkpoint.rollback.done': 'Ripristinato.',
  'checkpoint.rollback.failed': 'Ripristino fallito: {error}',
  'checkpoint.rollback.unknownError': 'Errore sconosciuto',
  'checkpoint.save': 'Salva',
  'checkpoint.empty': 'Nessun checkpoint ancora. Creane uno per salvare lo stato della conversazione.',
  ...
  'board.night.cpuThreshold': 'Si ferma sopra il {pct}% di CPU',
  ...
  'swapFreeze.what.test': 'Test in pausa',
  'swapFreeze.what.command': 'Comando in pausa',
  'swapFreeze.label': '{what}: il Mac è a corto di memoria. Riprende da solo entro le {at}, non devi fare niente.',
  'swapFreeze.title': 'Comando: {command} ({gb} GB). Topics lo ha fermato perché il Mac era in swap e rileggeva {rate} pagine al secondo dal disco. Riprende da solo entro 10 minuti, o prima se si libera memoria. Un test o una richiesta con un timeout in corso può scadere alla ripresa.',
  'swapFreeze.short': 'pausa',
  'swapFreeze.rowLine': 'In pausa: poca memoria',
  'swapFreeze.frozenShort': 'in pausa',
  'swapFreeze.thawed': 'Ripreso: il Mac è uscito dallo swap',
  ...
  'board.task.modelAutoOption': 'Auto (dal progetto)',
  ...
  'settings.machines.remote.title': 'Richieste per questo computer',
  'settings.machines.remote.blurb': 'Approva qui un’esecuzione chiesta da un’altra installazione. Scegli il checkout locale: la credenziale resta confinata fra i due server.',
  'settings.machines.remote.none': 'Nessuna richiesta in attesa.',
  'settings.machines.remote.otherComputer': 'Un altro computer',
  'settings.machines.remote.expires': 'Richiesta temporanea',
  'settings.machines.remote.checkout': 'Checkout locale',
  'settings.machines.remote.chooseCheckout': 'Scegli il progetto',
  'settings.machines.remote.identity': 'Identità locale',
  'settings.machines.remote.chooseIdentity': 'Scegli l’identità',
  'settings.machines.remote.scope': 'L’autorizzazione vale solo per questo progetto, questa politica e questa identità locale.',
  'settings.machines.remote.deny': 'Rifiuta',
  'settings.machines.remote.approve': 'Approva sul computer',
  'settings.machines.remote.loadFailed': 'Non è stato possibile caricare le richieste per questo computer.',
  'settings.machines.remote.decisionFailed': 'La richiesta non è stata aggiornata. Riprova da questo computer.',
  'settings.machines.remote.catalogRequest': 'Verifica catalogo del computer',
  'settings.machines.remote.authorizationRequest': 'Autorizzazione di esecuzione',
  ...
  'board.task.freshSessionQueued': 'Task in coda per una nuova sessione. Conversazione e feedback sono conservati.',
  ...
  'calendar.feedUrl': 'Indirizzo del feed del calendario',
  'calendar.feedUrl.how': 'In Google Calendar: Impostazioni, il tuo calendario, «Indirizzo segreto in formato iCal». Apple, Outlook, Proton e Fastmail pubblicano un link dello stesso tipo. Chi ce l’ha legge il calendario, quindi resta su questa macchina.',
  'calendar.feedUrl.placeholder': 'https://calendar.google.com/calendar/ical/.../basic.ics',
  'calendar.feedUrl.set': 'Un indirizzo è salvato. Scrivine un altro per sostituirlo.',
  'calendar.test': 'Prova',
  'calendar.save': 'Salva',
  'calendar.forget': 'Dimentica questo indirizzo',
  'calendar.probe.ok': 'Raggiunto {name}: {n} eventi nella prossima settimana.',
  'calendar.unnamed': 'il calendario',
  'calendar.unreachable': 'Il calendario non risponde.',
  'calendar.saveFailed': 'L’impostazione non è stata salvata.',
  'calendar.refresh': 'Rileggi al massimo ogni',
  'calendar.refresh.hint': 'Non si scarica niente mentre nessuno guarda: questa è l’età massima dell’agenda quando la guardi.',
  'calendar.horizon': 'L’agenda guarda avanti',
  'calendar.horizon.hint': 'Fin dove tessera e pannello elencano gli eventi.',
  'calendar.minutes': '{n} minuti',
  'calendar.days.one': '{n} giorno',
  'calendar.days': '{n} giorni',
  'calendar.agenda.empty': 'Non c’è niente in programma.',
  'calendar.agenda.notConfigured': 'Sincronizza questo calendario per vedere qui l’agenda.',
  'calendar.agenda.configure': 'Configura',
  'calendar.agenda.join': 'Entra',
  'calendar.agenda.now': 'ora',
  'calendar.agenda.allDay': 'tutto il giorno',
  'calendar.agenda.syncedAt': 'alle {time}',
  ...
  'settings.org.guide.title': 'Collaborazione sul progetto',
  'settings.org.guide.accessTitle': 'Accedi al progetto.',
  'settings.org.guide.authorizeTitle': 'Autorizza questo computer.',
  'settings.org.guide.browser': 'Condividi il progetto con una persona o un dispositivo esistente, così i task visibili si aprono nel browser con il livello di contenuto scelto.',
  'settings.org.guide.machine': 'Scegli il computer collegato del collaboratore e concedi Avvio agenti per quel progetto, modello, impegno e durata. Account remoti e accessi di terze parti non sono prerequisiti automatici.',
  'settings.org.guide.statePerson': 'Persona presente',
  'settings.org.guide.stateDevice': 'Dispositivo collegato',
  'settings.org.guide.stateShared': 'Progetto condiviso',
  'settings.org.guide.stateStart': 'Avvio agenti autorizzato',
  'settings.org.guide.todoPerson': 'Aggiungi il collaboratore',
  'settings.org.guide.todoDevice': 'Collega il suo dispositivo',
  'settings.org.guide.todoShared': 'Condividi il progetto',
  'settings.org.guide.todoStart': 'Autorizza Avvio agenti',
  'settings.org.guide.ownership': 'L’installazione resta proprietaria del progetto. Questi passaggi concedono una collaborazione confinata; non trasferiscono la proprietà.',
  'settings.org.guide.copyLink': 'Copia link installazione',
  'settings.org.guide.linkCopied': 'Link installazione copiato',
  'settings.org.guide.pairing': 'Apri questo link sul computer del collaboratore. Il proprietario dell’installazione verifica il codice di pairing; dopo l’approvazione, quel computer apre la vista ospite confinata. Non usa Google, OTP o un link anonimo di condivisione.',
  ...
  'board.dispatch.runningResources': '{running} agent al lavoro',
  'board.dispatch.resourcesHint': 'La quota si prende su ciò che il resto della macchina lascia libero: i processi che non sono di Topics hanno la precedenza. Un agent nuovo parte solo se ci sta anche lui.',
  'board.dispatch.budget': 'Quota di Topics',
  'board.dispatch.budgetOfFree': '{pct}% del libero',
  'board.dispatch.liveFree': 'Topics usa {used} dei {usable} core a disposizione',
  'board.dispatch.howItWorks': 'Come funziona',
  'board.gauge.budgetLine': 'Topics usa il {pct}% della CPU disponibile',
  'board.dispatch.budgetHint': 'A macchina ferma: {units} core-unità e {mem} GB di RAM su {cores} core.',
  'board.gauge.frozen': '{n} check congelati per carico: ripartono da soli',
  'board.dispatch.liveLoading': 'Leggo la macchina…',
  'board.dispatch.verdictGo': 'un agent nuovo partirebbe',
  'board.dispatch.liveFreePending': 'Topics usa {used} dei {usable} core a disposizione ({n} appena partiti)',
  'board.dispatch.liveFreePendingOne': 'Topics usa {used} dei {usable} core a disposizione (1 appena partito)',
  // The wait sentences: ONLY percentages of the whole Mac, never
  // core/core-unit/load. The resume threshold shows only when it is honestly
  // derived from the gate's own numbers (`admissionVerdictText`); otherwise
  // the sentence stops after the current percentage, no invented target.
  'board.dispatch.verdictWaitCpu': 'In attesa: il Mac è al {pct}% di CPU, parte da solo sotto il {resume}%',
  'board.dispatch.verdictWaitCpuBare': 'In attesa: CPU alta, un agent in più ne costerebbe il {cost}%',
  'board.dispatch.verdictWaitCpuUnmeasured': 'In attesa: CPU alta',
  'board.dispatch.verdictWaitMemory': 'In attesa: il Mac è al {pct}% di memoria, parte da solo sotto il {resume}%',
  'board.dispatch.verdictWaitMemoryBare': 'In attesa: il Mac è al {pct}% di memoria',
  'board.dispatch.verdictWaitMemoryUnmeasured': 'In attesa: memoria alta (non misurata su questo Mac)',
  'board.dispatch.verdictWaitFloor': 'In attesa: {reason}',
  'board.dispatch.verdictWaitFloorBare': 'In attesa: la macchina non ha spazio, riparte da sola quando si libera',
  'board.dispatch.verdictWaitDrain': 'In attesa: riavvio del server in arrivo, riparte da solo dopo',
  'board.dispatch.verdictFirst': 'il primo parte comunque',
  'board.filter.assignee': 'Assegnatario',
  'board.filter.person': 'Persona',
  'board.filter.computer': 'Computer',
  'board.filter.initiator': 'Chi ha avviato',
  'board.filter.runComputer': 'Computer di esecuzione',
  ...
  'board.gc.noAnswer': 'Il GC non ha risposto',
  'board.plan.paneTitle': 'Piano',
  'board.projectPicker.noMatch': 'Nessun progetto corrisponde.',
  'board.projectPicker.none': 'Nessun progetto trovato.',
  'board.projectPicker.create': 'Crea «{name}»…',
  ...
  'board.label.originAgent': "Chiesta dall'agent",
  'board.label.originHuman': 'Messa a mano',
  'board.reviewNotes.head.one': 'Revisione del diff: 1 commento su {files} file.',
  'board.reviewNotes.head.many': 'Revisione del diff: {n} commenti su {files} file.',
  'board.reviewNotes.removedLine': '(riga rimossa, numerazione precedente)',
  'board.reviewNotes.footer': 'Rispondi punto per punto, con una modifica o con il motivo per cui resta così. Poi committa e rimetti il task in review.',
  'board.choice.archiveRunning.title': 'Archiviare un task in corso?',
  'board.choice.archiveRunning.confirm': 'Archivia e ferma',
  'board.choice.archiveRunning.body': "Su questo task c'è un agent al lavoro: archiviandolo il suo turno viene interrotto e non riprende.",
  'board.choice.deliverNow.message': "Consegna adesso quello che hai: chiudi con quello che è già fatto, scrivi un commento di sintesi e metti il task in review.",
  'board.choice.failed': '{what} non è riuscito',
  'board.dispatch.queued': 'in coda',
  'board.dispatch.waiting': 'rinviata',
  'board.dispatch.waiting.title': 'Aspetta una condizione esterna: lo slot è libero, riparte da sola',
  'board.dispatch.starting': 'avvio…',
  'board.dispatch.working': 'al lavoro',
  'board.dispatch.needsInput': 'serve te',
  'board.dispatch.delivered': 'consegnato',
  'board.dispatch.delivered.title': "L'agent ha consegnato: aspetta la tua review",
  'board.dispatch.deliveredBySystem': 'corsa finita',
  'board.dispatch.deliveredBySystem.title': "L'ho portato io in review: l'agent non l'ha consegnato. Guarda il thread prima di valutare",
  'board.dispatch.deliveredEmpty': 'niente da vedere',
  'board.dispatch.deliveredEmpty.title': "Nessun ramo, nessun commit, nessun file toccato: non c'e' un diff da guardare",
  'board.dispatch.failed': 'fallito',
  'board.dispatch.blocked': 'da sistemare',
  'board.dispatch.stopped': 'fermato',
  'board.dispatch.waitedOut': 'troppa attesa',
  'board.systemDelivery.retriesExhausted': "L'agent ha finito i tentativi senza mettere in review da solo: sotto può non esserci un deliverable. Rimandandolo indietro riparte sulla stessa sessione.",
  'board.systemDelivery.modelRefused': 'Il modello si è rifiutato di proseguire: nessun ritentativo automatico può sbloccarlo. Serve una decisione tua: rimandarlo indietro identico otterrebbe lo stesso rifiuto.',
  'board.systemDelivery.fanout': 'Fan-out: più agenti hanno lavorato lo stesso task in parallelo, ognuno nel suo worktree. Scegli quale tentativo tenere dal pannello Tentativi. Gli altri vengono buttati.',
  'board.systemDelivery.parkedChildren': "Non è un blocco, è una domanda: gli unici sottotask aperti sono parcheggiati in backlog, dove nessun dispatcher li prende. Rispondi coi due bottoni e il task riparte da solo.",
  'board.systemDelivery.unknown': "Non l'ha consegnato l'agent: ce l'ha portato il sistema a fine turno. Sotto può non esserci un deliverable. Guarda il thread prima di aprire il diff.",
  'board.systemDelivery.chip.retriesExhausted': 'turni finiti',
  'board.systemDelivery.chip.modelRefused': 'agent bloccato',
  'board.systemDelivery.chip.fanout': 'scegli il tentativo',
  'board.systemDelivery.chip.parkedChildren': 'sottotask parcheggiati',
  'board.systemDelivery.chip.unknown': 'portata dal sistema',
  'board.blocked.on': 'aspetta: {what}',
  'board.blocked.onTitle': 'Questa card aspetta «{what}»: non parte finché quella non chiude.',
  'board.blocked.unknown': 'aspetta un altro task',
  'board.blocked.unknownTitle': 'Questa card aspetta un altro task: non parte finché quello non chiude. Il titolo non è disponibile qui.',
  'board.waitingOnThis.one': '1 la aspetta',
  'board.waitingOnThis.oneTitle': 'Un task aspetta questa card: parte da solo quando la chiudi.',
  'board.waitingOnThis.many': '{n} la aspettano',
  'board.waitingOnThis.manyTitle': '{n} task aspettano questa card: partono da soli quando la chiudi.',
  'board.subtaskWork.unattended': 'nessuno la lavora',
  'board.subtaskWork.unattendedTitle': 'In corso, ma senza agente suo e senza nessun antenato al lavoro: è rimasta qui. Rimettila in coda o chiudila.',
  'board.subtaskWork.parentTurn': 'nel turno del padre',
  'board.subtaskWork.parentTurnTitle': "La lavora l'agente di: {what}",
  'board.reopened.label': 'riaperta',
  'board.reopened.byYou': 'da te',
  'board.reopened.bySystem': 'dal sistema',
  'board.reopened.byAgent': 'da un agent',
  'board.reopened.byNamedAgent': 'da un agent ({who})',
  'board.reopened.detail': '{who} il {when}',
  'board.reopened.title': 'Aveva consegnato: riaperta {detail}. Il motivo è nel thread della card.',
  ...
  'board.load.usage': 'Topics usa il {pct}% della CPU del Mac',
  'board.load.machineBusy': 'Il Mac è carico al {pct}%: ogni agent in più rallenta anche gli altri.',
  'board.load.advice': 'È un consiglio, non un tetto: il vero limite sta nelle impostazioni della board.',
  ...
  'board.gauge.light': 'leggero',
  'board.gauge.full': 'pieno',
  'board.gauge.over': 'oltre il limite',
  'board.gauge.noLimit': 'senza limite',
  'board.gauge.reading': 'leggo…',
  'board.gauge.aria': 'Carico del dispatcher: {running} di {limit} agent al lavoro. Apri per i numeri.',
  'board.gauge.ariaNoLimit': '{running} agent al lavoro, nessun tetto',
  'board.gauge.ariaReading': 'Leggo il carico del dispatcher…',
  'board.gauge.ofLimit': '{running} di {limit}',
  'board.gauge.popoverTitle': 'Carico del dispatcher',
  'board.gauge.modeAuto': 'Tetto automatico',
  'board.gauge.modeFixed': 'Tetto fisso',
  'board.gauge.modeOff': 'Nessun tetto',
  'board.gauge.modeResources': 'Quota: {pct}% del libero',
  'board.gauge.derived': 'ricavato dalla macchina ({cores}) → tetto {limit}',
  'board.gauge.spendToday': 'spesa nelle ultime 24h {amount}',
  'board.gauge.byResources': 'a budget',
  'board.gauge.wait.cpu': 'aspetta: CPU',
  'board.gauge.wait.memory': 'aspetta: memoria',
  'board.gauge.wait.floor': 'fermo: niente spazio',
  'board.gauge.wait.drain': 'fermo: riavvio',
  'board.gauge.memLine': 'memoria: Topics tiene {ours} GB, liberi per Topics {free} GB, un agent ne chiede {cost}',
  'board.gauge.ariaResources': '{running} agent al lavoro, usano il {pct}% della CPU disponibile',
  'board.gauge.settings': 'Impostazioni',
  // The two big popover percentages: CPU and memory of the whole Mac, never
  // Topics' own private core budget.
  'board.gauge.cpuLabel': 'CPU',
  'board.gauge.memLabel': 'Memoria',
  'board.gauge.notMeasured': 'non misurata',
  'board.gauge.agentsOfMax': 'Agent al lavoro {running} / massimo {max}',
  'board.gauge.agentsNoLimit': 'Agent al lavoro {running}, nessun tetto',
  'board.gauge.agentsPlain': 'Agent al lavoro {running}',
  'board.gauge.details': 'Dettagli',
  ...
  'board.orchestrator.popOut': 'Apri in una tab',
  ...
  'board.composer.modelAutoTitle': 'Segue la scelta del progetto. In Auto, Topics sceglie tra i modelli collegati, disponibili e compatibili con il task, su tutti i provider.',
  'board.composer.modelAutoChip': 'Modello auto',
  'board.composer.modelAuto': 'Auto (dal progetto)',
  'board.composer.modelAutoOptionTitle': 'Segue la scelta del progetto; con Auto sceglie tra tutti i provider collegati e compatibili con il task',
  ...
  'chat.turnError.details': 'Dettagli tecnici',
  'chat.turnError.copy': 'Copia i dettagli',
  'chat.turnError.detailsTruncated': 'Dettagli tecnici (payload salvato troncato)',
  ...
  'runtime.topics': 'Topics (nativo, solo Claude)',
  'runtime.cli': 'CLI (un processo per sessione)',
  'runtime.jcode': 'jcode (demone condiviso)',
  'runtime.blurb': 'Topics esegue nativamente gli agenti Claude nel server, usando le credenziali di un login Claude già presente. Collegare una chiave API per le chat non configura questo login. Per i task GPT serve il runtime Codex; scegliere Topics non lo sostituisce.',
  'runtime.missing': 'Scelto, ma non ancora fra i provider: serve un riavvio del server, e l’eseguibile jcode dev’essere nel PATH.',
  'runtime.defaultUnavailable': 'Il runtime nativo Claude non è disponibile su questo server. Verifica il login Claude e riavvia il server dopo la configurazione. Gli agenti usano il runtime CLI quando disponibile.',
  ...
  'terminal.inputLost.expired': 'Quello che hai scritto durante il riaggancio era troppo vecchio per partire.',
  'terminal.inputLost.tooLong': 'Quello che hai scritto durante il riaggancio era troppo lungo per la coda: non è partito niente.',
  'terminal.inputLost.disconnected': 'La connessione è caduta prima che quello che hai scritto potesse partire.',
  'terminal.inputLost.retype': 'Riscrivilo.',
  ...
  'palette.seeAllHistory': 'Vedi tutta la cronologia',
  ...
  'browser.dev.width': 'Larghezza in pixel',
  'browser.dev.height': 'Altezza in pixel',
  ...
  'statusBar.providerHold.heading': 'Limite Claude raggiunto',
  'statusBar.providerHold.fiveHours': 'Finestra di utilizzo di 5 ore.',
  'statusBar.providerHold.week': 'Limite settimanale del piano Claude.',
  'statusBar.providerHold.reset': 'Reset: {date}',
  'statusBar.providerHold.unknownReset': 'orario non disponibile',
  'statusBar.providerHold.queuePaused': 'I task Claude attendono il reset. I task con altri provider possono continuare.',
  'statusBar.providerHold.otherChats': 'Per continuare in una nuova chat puoi scegliere un altro provider.',
  'statusBar.providerHold.manage': 'Gestisci provider AI',
  'statusBar.planUsage.heading': 'Utilizzo Claude: {pct}%',
  'statusBar.planUsage.remaining': 'La quota rimanente è condivisa tra chat e agenti Claude.',
  ...
  'statusBar.system.title': 'Sistema',
  'statusBar.system.performance': 'Prestazioni',
  ...
  'share.agentStart.title': 'Avvio agenti',
  'share.agentStart.blurb': 'Autorizzazione separata per avviare un agente su questo progetto con una politica fissa.',
  'share.agentStart.add': 'Autorizza',
  'share.agentStart.subject': 'Chi',
  'share.agentStart.computer': 'Computer',
  'share.agentStart.model': 'Modello',
  'share.agentStart.chooseModel': 'Scegli un modello',
  'share.agentStart.noVerifiedModels': 'Nessun modello verificato',
  'share.agentStart.modelUnavailable': 'Modello non disponibile',
  'share.agentStart.modelUnverified': 'Supporto del nodo non verificato',
  'share.agentStart.remoteModelsUnverified': 'Il nodo remoto non ha dichiarato i modelli supportati, quindi non è ancora possibile creare una nuova autorizzazione.',
  'share.agentStart.effort': 'Impegno',
  'share.agentStart.duration': 'Durata massima',
  'share.agentStart.minutes': '{n} min',
  'share.agentStart.repository': 'Repository associato: {repository}',
  'share.agentStart.confirm': 'Confermo che questa persona può avviare un agente alla volta su questo progetto e computer, con questa politica.',
  'share.agentStart.policyNote': 'Un tentativo, senza ripetizioni né avvii paralleli. Restano validi i blocchi e i limiti più stretti della board.',
  'share.agentStart.confirmAction': 'Conferma autorizzazione',
  'share.agentStart.revokeFor': 'Revoca Avvio agenti per {name}',
  'share.agentStart.loadFailed': 'Non è stato possibile caricare le autorizzazioni Avvio agenti.',
  'share.agentStart.saveFailed': 'Non è stato possibile autorizzare Avvio agenti. Verifica il computer e il repository associato.',
  'share.agentStart.revokeFailed': 'Non è stato possibile revocare Avvio agenti. Riprova.',
  'share.agentStart.remoteState.pending': 'In attesa di approvazione sul computer remoto',
  'share.agentStart.remoteState.approved': 'Approvata, collegamento in corso',
  'share.agentStart.remoteState.active': 'Computer remoto autorizzato',
  'share.agentStart.remoteState.denied': 'Richiesta rifiutata',
  'share.agentStart.remoteState.expired': 'Richiesta scaduta',
  'share.agentStart.remoteState.revoked': 'Autorizzazione revocata',
  'share.agentStart.remoteState.failed': 'Collegamento non completato',
  'share.agentStart.remoteStatusNote': 'Il codice serve solo per confrontare la richiesta; nessuna credenziale viene mostrata nel browser.',
  'share.agentStart.remoteReissue': 'Genera un nuovo codice',
  'share.agentStart.remoteRequestRevoke': 'Revoca il collegamento remoto',
  'share.agentStart.remoteRequestFailed': 'Non è stato possibile generare un nuovo codice. Riprova.',
  'share.agentStart.remoteRevokeFailed': 'La revoca remota non è stata completata. Riprova.',
  'share.agentStart.verifyComputer': 'Verifica computer',
  'share.agentStart.catalogNote': 'Prima verifica checkout e modelli disponibili sul computer. Questo passaggio non concede Avvio agenti.',
  'share.agentStart.catalogFailed': 'Non è stato possibile avviare la verifica del computer. Riprova.',
  'share.agentStart.catalogState.pending': 'In attesa di verifica sul computer remoto',
  'share.agentStart.catalogState.approved': 'Verifica approvata, lettura del catalogo',
  'share.agentStart.catalogState.active': 'Catalogo verificato, nessun modello disponibile',
  'share.agentStart.catalogState.denied': 'Verifica rifiutata',
  'share.agentStart.catalogState.expired': 'Verifica scaduta',
  'share.agentStart.catalogState.revoked': 'Verifica revocata',
  'share.agentStart.catalogState.failed': 'Verifica non completata',
  'board.card.runInitiator': 'Avviato da {name}',
  'board.card.runInitiatorTitle': '{name} ha richiesto questa esecuzione delegata',
  'board.card.runComputerTitle': 'Esecuzione delegata eseguita su {name}',
  ...
  'board.queue.resourcePressure.head': 'in attesa',
  'board.queue.resourcePressure.detail': 'la macchina è occupata',
  'board.queue.resourcePressure.title': 'Il tetto è impostato per risorse e la macchina è sopra la soglia che hai scelto, quindi non parte nessun agente nuovo. Riparte da sé appena il carico o la memoria rientrano, e la soglia si sposta dalle impostazioni della board. {reason}',
  'board.queue.nodeUnreachable.head': 'nodo muto',
  'board.queue.nodeUnreachable.detail': '{node} non risponde',
  'board.queue.nodeUnreachable.title': 'La card deve girare sul nodo {node}, e il nodo non risponde. Resta in coda finché torna: non parte qui, perché una macchina spenta non è un motivo per eseguire il lavoro altrove.',
