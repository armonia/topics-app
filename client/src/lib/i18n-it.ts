...
const IT: Dict = {
  ...
  'browser.tab.kind.heavy': 'Consumo alto: {cpu}% di un core. Va in pausa quando lasci questa scheda',
  'browser.tab.kind.heavyPaused': 'In pausa per risparmiare CPU',
  'browser.heavy.paused.title': 'In pausa',
  'browser.heavy.paused.body': 'Questa pagina usava il {cpu}% di un core. Riprende da dove era quando la selezioni.',
  ...
  'swapFreeze.label': 'Congelato: {command}, {gb} GB, Mac in swap',
  'swapFreeze.title': 'Topics lo ha fermato perché il Mac rileggeva {rate} pagine al secondo dal disco. Riprende da solo entro 10 minuti, o prima se si libera memoria. Un test o una richiesta con un timeout in corso può scadere alla ripresa.',
  'swapFreeze.frozenShort': 'congelato',
