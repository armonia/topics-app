...
const IT: Dict = {
  ...
  'board.dispatch.liveFree': '{used} di {usable} core a disposizione',
  'board.dispatch.howItWorks': 'Come funziona',
  'board.gauge.budgetLine': '{running} agent, {used} di {usable} core a disposizione',
  ...
  'board.gauge.ariaResources': '{running} agent al lavoro, {used} di {usable} core a disposizione',
