...
const IT: Dict = {
  ...
  'ai.advanced.title': 'Avanzate · esecuzione degli agenti',
  'ai.advanced.hint': 'Runtime, programmi locali, strumenti MCP e checkpoint. Il motore nativo Topics supporta attualmente solo Claude; i task GPT richiedono Codex.',
  ...
  'statusBar.providerHold.queuePaused': "L'avvio automatico dei task attende il reset.",
