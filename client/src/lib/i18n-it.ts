...
const IT: Dict = {
  ...
  'board.gauge.budgetLine': '{running} agent, usano {used} dei {usable} core a disposizione',
  ...
  'board.dispatch.verdictWaitCpu': 'i nuovi aspettano: CPU, un agent ne costa {cost} core',
  'board.dispatch.verdictWaitCpuResume': 'i nuovi aspettano: CPU, si riparte sotto {resume} core',
  'board.dispatch.verdictWaitMemory': 'i nuovi aspettano: memoria, servono {cost} GB, liberi per Topics {free} GB',
  'board.dispatch.verdictWaitMemoryFootprint': 'i nuovi aspettano: memoria, Topics tiene {ours} GB su un tetto di {ceiling} GB',
  'board.dispatch.verdictWaitMemoryBare': 'i nuovi aspettano: memoria',
  'board.dispatch.verdictWaitFloor': 'i nuovi aspettano: {reason}',
  'board.dispatch.verdictWaitFloorBare': 'i nuovi aspettano: la macchina non ha spazio',
  'board.dispatch.verdictWaitDrain': 'i nuovi aspettano: riavvio del server in arrivo',
  ...
  'board.gauge.inFlight': '{running} agent in volo',
  ...
  'board.gauge.ariaResources': '{running} agent al lavoro, usano {used} dei {usable} core a disposizione',
