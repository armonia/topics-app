...
const IT: Dict = {
  ...
  'board.dispatch.resourcesHint': 'Un agent nuovo parte solo se quello che Topics sta già usando, più il costo di uno nuovo, sta nel budget. Il numero fisso qui non si applica.',
  'board.dispatch.budget': 'Topics può usare fino al',
  'board.dispatch.budgetOfPc': '{pct}% del PC',
  'board.dispatch.budgetHint': 'Vale su CPU e memoria insieme: {cores} core → {units} core-unità, {mem} GB di RAM.',
  'board.dispatch.liveUse': 'Adesso Topics usa il {pct}% del PC ({used} di {budget} core-unità)',
  'board.dispatch.liveUseSqueezed': 'Adesso Topics usa il {pct}% del PC ({used} di {budget} core-unità; ne sono libere {usable}, il resto della macchina sta lavorando)',
  'board.gauge.budgetUse': 'Topics usa il {pct}% del PC su un budget del {budget}%',
  'board.gauge.budgetCores': '{used} core-unità su {budget} di budget',
  ...
  'board.gauge.modeResources': 'Freno sulle risorse della macchina',
  ...
  'board.gauge.ariaResources': '{running} agent al lavoro, Topics usa il {pct}% del PC su un budget del {budget}%',
