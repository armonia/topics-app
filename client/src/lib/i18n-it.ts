...
const IT: Dict = {
  ...
  'background.notice.deferred.autonomy': "Il cambio di autonomia vale dal primo messaggio dopo la fine del lavoro in background",
  'background.notice.deferred.model': 'Il cambio di modello vale dal primo messaggio dopo la fine del lavoro in background',
  'background.notice.deferred.effort': "Il cambio di effort vale dal primo messaggio dopo la fine del lavoro in background",
  ...
  'board.night.load': 'Occupazione del Mac',
  ...
  'board.checksFloor.fold': 'Avanzate: spazio per i controlli',
  ...
  'board.dispatch.resourcesHint': 'Topics prende la sua parte di ciò che gli altri programmi del Mac lasciano libero: loro hanno la precedenza. Un agent nuovo parte solo se ci sta anche lui.',
  'board.dispatch.budget': 'Quanto può usare Topics',
  'board.dispatch.budgetOfFree': 'fino {pctAl} del Mac libero',
  'board.dispatch.liveFree': 'Topics usa {usedIl} del Mac, può arrivare {ceilAl}',
  'board.dispatch.howItWorks': 'Come funziona',
  'board.gauge.budgetLine': 'Topics usa {usedIl} del Mac, può arrivare {ceilAl}',
  ...
  'board.dispatch.liveFreePending': 'Topics usa {usedIl} del Mac, può arrivare {ceilAl} ({n} appena partiti)',
  'board.dispatch.liveFreePendingOne': 'Topics usa {usedIl} del Mac, può arrivare {ceilAl} (1 appena partito)',
  ...
  'board.dispatch.verdictWaitFloor': 'In attesa: il Mac è quasi pieno, riparte da solo quando si libera spazio',
  'board.dispatch.verdictWaitFloorBare': 'In attesa: il Mac è quasi pieno, riparte da solo quando si libera spazio',
  ...
  'board.gauge.modeResources': 'Quota: fino {pctAl} del Mac libero',
  'board.gauge.derived': '{cores} core → {limit}',
  'board.gauge.spendToday': 'spesa nelle ultime 24h {amount}',
  'board.gauge.byResources': 'a budget',
  'board.gauge.wait.cpu': 'aspetta: Mac occupato',
  'board.gauge.wait.memory': 'aspetta: Mac occupato',
  ...
  'board.gauge.ariaResources': '{running} agent al lavoro, Topics usa {pctIl} del Mac',
  ...
  'board.gauge.agentsOfMax': '{running} agent al lavoro, massimo {max}',
  'board.gauge.agentsNoLimit': '{running} agent al lavoro, nessun tetto',
  'board.gauge.agentsPlain': '{running} agent al lavoro',
  ...
  'machine.busy': 'Il Mac è occupato {pctAl}',
  'machine.busyUnknown': 'Occupazione del Mac non misurabile',
  ...
  'chat.machineStop.superseded': 'Fermato: il lavoro della card è già atterrato o è passato altrove',
  ...
  'statusBar.load.calmo': 'Il Mac è occupato {pctAl}: tutto tranquillo',
  ...
  'board.queue.resourcePressure.title': 'Il tetto è impostato per risorse e il Mac è più occupato della quota che hai scelto, quindi non parte nessun agente nuovo. Riparte da sé appena il Mac si libera, e la quota si sposta dalle impostazioni della board. {reason}',
