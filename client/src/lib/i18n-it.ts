...
const IT: Dict = {
  ...
  'goal.loop.stalled': 'Obiettivo: auto-continuazione in pausa, non si muoveva niente. Riprende al tuo prossimo messaggio',
  ...
  'chat.command.modelSet': 'Modello impostato: {model}',
  'chat.command.effortSet': 'Effort impostato: {level}',
