...
const IT: Dict = {
  ...
  'task.model.hint': "Modello dell'agente. Auto sceglie un agente di coding disponibile.",
  'task.model.sessionFixed': 'Il modello è fissato alla sessione già assegnata a questo task.',
