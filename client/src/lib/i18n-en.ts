...
const EN = {
  ...
  'statusBar.planUsage.title': "How full the Claude plan's five-hour window is. Above the threshold the board stops starting new cards: what is left goes to the turns in flight and to your own chats.",
  'statusBar.planUsage.fiveHours': 'Five-hour window at {pct}%: reset at {time}',
