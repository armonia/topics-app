...
const EN = {
  ...
  'board.dispatch.runningResources': '{running} working, braking on machine resources',
  'board.dispatch.resourcesHint': 'A new agent starts only if what Topics is already using, plus the cost of one more, fits the budget. The fixed number does not apply here.',
  'board.dispatch.budget': 'Topics may use up to',
  'board.dispatch.budgetOfPc': '{pct}% of the PC',
  'board.dispatch.budgetHint': 'One knob for CPU and memory: {cores} cores gives {units} core-units and {mem} GB of RAM.',
  'board.dispatch.liveUse': 'Topics is using {pct}% of the PC right now ({used} of {budget} core-units)',
  'board.dispatch.liveUseSqueezed': 'Topics is using {pct}% of the PC right now ({used} of {budget} core-units; {usable} are free, the rest of the machine is working)',
  'board.gauge.budgetUse': 'Topics is using {pct}% of the PC on a {budget}% budget',
  'board.gauge.budgetCores': '{used} core-units of a {budget} budget',
  'board.gauge.frozen': '{n} checks frozen for load: they resume by themselves',
  'board.dispatch.liveLoading': 'Reading the machine...',
  'board.dispatch.verdictGo': 'A new agent would start right now.',
  'board.dispatch.verdictWait': 'A new agent would wait right now: Topics is at its budget.',
  'board.dispatch.verdictFirst': 'Over the budget, but with no agent working the first one starts anyway.',
  ...
  'board.gauge.ariaResources': '{running} agents working, Topics is using {pct}% of the PC on a {budget}% budget',
