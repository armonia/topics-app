...
const EN = {
  ...
  'ai.selector.ready': 'Ready',
  'ai.selector.unavailableShort': 'Unavailable',
  'ai.selector.unavailable': 'This execution engine is unavailable on this server.',
  'ai.selector.noLongerAvailable': 'The saved choice is no longer available on this server.',
  'ai.selector.openSettings': 'Open settings',
  'ai.selector.chooseModel': 'Choose a compatible model',
  ...
  'app.viewByState': 'View by state',
  'app.viewTimeline': 'Timeline view',
  ...
  'update.title.idle': 'Updates',
  'update.title.checking': 'Checking…',
  'update.title.upToDate': 'You are up to date',
  'update.title.available': 'Update{v} available',
  'update.title.downloading': 'Downloading{pct}…',
  'update.title.ready': 'Ready to install',
  'update.detail.localShell': 'Installed shell v{shell}',
  ...
  'guest.level.read': 'You can view',
  'guest.level.comment': 'You can comment',
  'guest.level.edit': 'You can edit the text',
  'guest.editText': 'Edit the card text',
  'guest.commentPlaceholder': 'Write a comment',
  'guest.sendComment': 'Send the comment',
  'guest.writeFailed': 'I could not save it. Try again.',
  'guest.start.action': 'Start',
  'guest.start.queued': 'Queued. The owner’s policy is in force.',
  'guest.start.working': 'The agent is working.',
  'guest.start.completed': 'The run completed.',
  'guest.start.cancelled': 'The run was cancelled.',
  'guest.start.failed': 'The agent could not start. Check that authorization is still active and try again.',
  'guest.start.policy': 'Runs on {computer}',
  'guest.start.authorizedComputer': 'the authorized computer',
  ...
  'pair.guestBlurb': 'Someone else sees only what you share with them, at the level you choose.',
  'pair.requestsAccess': '{name} requests access',
  'pair.deny': 'Deny',
  'pair.choosePerson': 'Choose an existing person',
  'pair.createPerson': 'Create a new person',
  'pair.chooseExisting': 'Choose an existing person',
  ...
  'ai.agents.hint': 'Codex can use your ChatGPT subscription for GPT tasks. Available agents can work in projects; installation and runtime controls are in advanced options.',
  'ai.api.title': 'Chat APIs',
  'ai.api.intro': 'Connect OpenAI for GPT or Anthropic for Claude. Then choose a provider and model in the chat composer, or set a default.',
  'ai.api.billing': 'API usage is billed by the provider. ChatGPT and Claude subscriptions are separate and do not include this usage.',
  'ai.api.chat': 'Chat through an API, with no CLI to install. Agents that work on files need a compatible runtime.',
  'ai.status.ready': 'Connected',
  'ai.status.loading': 'Connecting…',
  'ai.status.error': 'Needs attention',
  'ai.status.unavailable': 'Not configured',
  'ai.endpoints.title': 'Your own endpoints',
  'ai.endpoints.hint': 'Any OpenAI-compatible server you run yourself: llama-server, vLLM, LM Studio, a gateway. Usable in chats, not for agents that work on files.',
  'ai.endpoints.add': 'Add an endpoint',
  'ai.endpoints.label': 'Name',
  'ai.endpoints.labelPlaceholder': 'Local llama',
  'ai.endpoints.url': 'Base URL',
  'ai.endpoints.token': 'Bearer token',
  'ai.endpoints.tokenPlaceholder': 'Leave empty if the endpoint needs no token',
  'ai.endpoints.tokenSet': 'token set',
  'ai.endpoints.test': 'Test',
  'ai.endpoints.save': 'Save',
  'ai.endpoints.cancel': 'Cancel',
  'ai.endpoints.remove': 'Remove this endpoint',
  'ai.endpoints.reachable': 'Reachable, {n} models.',
  'ai.endpoints.unreachable': 'The endpoint did not answer.',
  'ai.api.notConnected': 'Not connected',
  'ai.api.key': 'API key',
  'ai.api.replaceKey': 'Replace API key',
  'ai.api.connect': 'Verify and connect',
  'ai.api.connecting': 'Verifying…',
  'ai.api.storage': 'The key is verified and saved on the Topics server for this installation. Verification reads the model catalog without generating a response.',
  'ai.api.saved': 'Key verified and saved.',
  'ai.api.nextTurn': 'Applies from the next turn.',
  'ai.api.keyRejected': 'API key rejected. Check the key and provider permissions.',
  'ai.api.saveError': 'Could not save the key.',
  'ai.local.title': 'Local programs',
  'ai.local.loadFailed': 'Could not read the program list.',
  'ai.local.saveFailed': 'Could not save that path.',
  'ai.local.notFound': 'Not found',
  'ai.local.changePath': 'Change path',
  'ai.local.setPath': 'Set path',
  'ai.local.copied': 'Copied',
  'ai.local.copy': 'Copy',
  'ai.local.missingPath': 'The path you set is no longer there: {path}',
  'ai.local.clearPath': 'Clear',
  'ai.local.pathHint': 'The full path to the program or its folder. Run {command} in a terminal to find it.',
  'ai.execution.title': 'Execution',
  'ai.local.hint': 'Programs Topics can use to run agents. If an installed program is missing, specify its path.',
  'ai.advanced.title': 'Execution and local programs',
  ...
  'task.comment.answer': 'Answer the open question: the agent restarts from this line',
  ...
  'task.model.hint': 'Follows the project choice. With Auto, Topics selects among connected, available models compatible with the task, across all providers. You can also set a model.',
  'task.model.sessionFixed': '{model}: the model is fixed to the session already assigned to this task.',
  ...
  'topicBrowser.add': 'New sheet',
  'topicBrowser.newSheet': 'Blank sheet',
  'topicBrowser.openAsTab': 'Open as tab',
  ...
  'browser.tab.downloadsCue': '{n} downloads in this tab',
  ...
  'browser.tab.sheet.title': 'Page actions',
  'browser.tab.sheet.address': 'Address',
  'browser.tab.sheet.recent': 'In this tab',
  'browser.tab.sheet.tools': 'Tools',
  'browser.tab.sheet.session': 'Session',
  'browser.tab.engine.playwright': 'Engine: Playwright',
  'browser.tab.engine.chromium': 'Engine: Chromium · {n} extensions',
  'browser.tab.render.dom': 'Render: DOM',
  'browser.tab.render.video': 'Render: video',
  'browser.tab.kind.disconnected': 'Connection lost: the page is not updating',
  'browser.tab.kind.connecting': 'Connecting to the shared session',
  ...
  'browser.tab.kind.heavy': 'High usage: {cpu}% of the Mac\'s CPU. Pauses when you leave this tab',
  'browser.tab.kind.heavyPaused': 'Paused to save CPU',
  'browser.heavy.paused.title': 'Paused',
  'browser.heavy.paused.body': 'This page was using {cpu}% of the Mac\'s CPU. It picks up where it was.',
  'browser.heavy.paused.bodyCpuMem': 'This page was using {cpu}% of the CPU and {mem}% of the memory of the Mac. It picks up where it was.',
  'browser.heavy.paused.keepOnce': 'Keep it running this time',
  'browser.heavy.paused.keepAlways': 'Always keep this site running',
  'browser.heavy.paused.resume': 'Resume',
  ...
  'checkpoint.blocked.turnInProgress': 'A turn is still running in this chat: wait for it to finish before rolling back.',
  'checkpoint.blocked.otherSession': 'Another chat has written in this folder since: rolling back would undo its work too.',
  ...
  'checkpoint.plan.nothing': 'No file changed since this checkpoint: only the conversation moves.',
  'checkpoint.plan.skipped': '{n} paths were changed by somebody else since and are left alone:',
  'checkpoint.plan.more': '+{n} more',
  'checkpoint.plan.unknown': 'The file plan could not be read: the server decides what comes back when you confirm.',
  'checkpoint.rollback.refused': 'Rollback refused: {reason}',
  'checkpoint.rollback.title': 'Roll back to this checkpoint',
  'checkpoint.rollback.confirmTitle': 'Roll back to "{name}"?',
  'checkpoint.rollback.confirm': 'Roll back',
  'checkpoint.rollback.done': 'Rolled back.',
  'checkpoint.rollback.failed': 'Rollback failed: {error}',
  'checkpoint.rollback.unknownError': 'Unknown error',
  'checkpoint.save': 'Save',
  'checkpoint.empty': 'No checkpoints yet. Create one to save conversation state.',
  ...
  'board.night.cpuThreshold': 'Stops above {pct}% CPU',
  ...
  'tab.menu.zoom': 'Zoom',
  'tab.menu.unzoom': 'Unzoom',
  'tab.menu.zoomCellOnly': 'Zoom this one only',
  ...
  'swapFreeze.what.test': 'Test paused',
  'swapFreeze.what.command': 'Command paused',
  'swapFreeze.label': '{what}: the Mac is low on memory. It resumes on its own by {at}, nothing to do.',
  'swapFreeze.title': 'Command: {command} ({gb} GB). Topics stopped it because the Mac was swapping, reading {rate} pages per second back from disk. It resumes on its own within 10 minutes, or sooner if memory frees up. A test or a request with a timeout in flight can expire on resume.',
  'swapFreeze.short': 'paused',
  'swapFreeze.rowLine': 'Paused: low memory',
  'swapFreeze.frozenShort': 'paused',
  'swapFreeze.thawed': 'Resumed: the Mac is out of swap',
  ...
  'board.task.author.collaborator': 'Collaborator',
  'board.task.origin.interface': 'via interface',
  'board.task.origin.mcp': 'via MCP',
  'board.task.origin.api': 'via API',
  'board.task.origin.system': 'system',
  ...
  'board.task.modelAutoOption': 'Auto (project default)',
  'board.task.node.heading': 'Where it runs',
  'board.task.node.local': 'This machine',
  'board.task.node.chipLocal': 'here',
  'board.task.node.title': 'Which machine this card runs on. The choice is yours: no rule moves it on its own.',
  'board.task.node.runningTitle': 'The card is already running. Moving it to another node now would not actually move it: you pick before it starts.',
  'board.task.node.online': 'online',
  'board.task.node.offline': 'not answering',
  'board.task.node.empty': 'No paired node. You add one from settings, under Devices.',
  'board.task.node.on': 'on {node}',
  'board.task.node.onTitle': 'This card runs on the node {node}, not on this machine.',
  'settings.machines.pair.title': 'Nodes',
  'settings.machines.pair.blurb': 'A second machine that can run this board cards. The code is approved in front of it.',
  'settings.machines.pair.add': 'Add node',
  'settings.machines.pair.address': 'Node address',
  'settings.machines.pair.addressPlaceholder': 'https://node.local:3333',
  'settings.machines.pair.start': 'Request access',
  'settings.machines.pair.cancel': 'Cancel',
  'settings.machines.pair.codeIntro': 'Approve this code on the other machine:',
  'settings.machines.pair.codeWait': 'Waiting for someone to approve it there…',
  'settings.machines.pair.approved': '{name} is paired: this node can now be picked on a card.',
  'settings.machines.pair.denied': 'The request was refused on the other machine.',
  'settings.machines.pair.expired': 'The code expired before anyone approved it.',
  'settings.machines.pair.again': 'Try again',
  'settings.machines.pair.close': 'Close',
  'settings.machines.pair.error.unreachable': 'Nothing answered at that address. Check the node is on and that the address is the right one.',
  'settings.machines.pair.error.tlsUntrusted': 'This machine does not trust the node certificate. The node answers: it is its identity that cannot be verified from here.',
  'settings.machines.pair.error.hostNotAllowed': 'The node refuses this address: it is not among the ones it admits. Add it to its allowed hosts list, on the node.',
  'settings.machines.pair.error.unauthorized': 'The node answered, but it did not accept the pairing request.',
  'settings.machines.pair.error.serverError': 'The node answered with an error. The explanation is in its logs.',
  'settings.machines.pair.error.badAddress': 'The address has to be an http or https URL.',
  'settings.machines.pair.error.generic': 'The pairing did not go through.',
  'settings.machines.remote.title': 'Requests for this computer',
  'settings.machines.remote.blurb': 'Approve a run requested by another installation here. Choose the local checkout; the credential stays confined between the two servers.',
  'settings.machines.remote.none': 'No requests waiting.',
  'settings.machines.remote.otherComputer': 'Another computer',
  'settings.machines.remote.expires': 'Temporary request',
  'settings.machines.remote.checkout': 'Local checkout',
  'settings.machines.remote.chooseCheckout': 'Choose project',
  'settings.machines.remote.identity': 'Local identity',
  'settings.machines.remote.chooseIdentity': 'Choose identity',
  'settings.machines.remote.scope': 'This authorization is limited to this project, policy, and local identity.',
  'settings.machines.remote.deny': 'Deny',
  'settings.machines.remote.approve': 'Approve on this computer',
  'settings.machines.remote.loadFailed': 'Could not load requests for this computer.',
  'settings.machines.remote.decisionFailed': 'The request was not updated. Try again from this computer.',
  'settings.machines.remote.catalogRequest': 'Verify computer catalog',
  'settings.machines.remote.authorizationRequest': 'Execution authorization',
  ...
  'board.task.replyPlaceholder': 'Reply or send a correction to the agent…',
  'board.task.sendToAgent': 'Send to agent',
  ...
  'board.task.answerPlaceholder': 'Answer the question: the agent restarts from here.',
  ...
  'board.task.checks.runningProgress': 'Pre-review checks {done}/{total}',
  ...
  'board.task.checks.unknown': 'Checks NOT MEASURED',
  'board.task.checks.notMeasured': 'not measured',
  'board.task.checks.ciPr': 'pull request',
  'board.task.checks.ciRun': 'CI run',
  ...
  'calendar.blurb': 'Pin your calendar in the sidebar and hover the tile for a small preview of the open tab; click still opens it.',
  'calendar.sync': 'Sync this calendar',
  'calendar.sync.configured': 'The agenda is read from the feed you saved.',
  'calendar.sync.needsUrl': 'Add a feed address first.',
  'calendar.feedUrl': 'Calendar feed address',
  'calendar.feedUrl.how': 'In Google Calendar: Settings, your calendar, "Secret address in iCal format". Apple, Outlook, Proton and Fastmail publish the same kind of link. Anyone holding it can read the calendar, so it stays on this machine.',
  'calendar.feedUrl.placeholder': 'https://calendar.google.com/calendar/ical/.../basic.ics',
  'calendar.feedUrl.set': 'An address is saved. Type a new one to replace it.',
  'calendar.test': 'Test',
  'calendar.save': 'Save',
  'calendar.forget': 'Forget this address',
  'calendar.probe.ok': 'Reached {name}: {n} events in the next week.',
  'calendar.unnamed': 'the calendar',
  'calendar.unreachable': 'The calendar could not be reached.',
  'calendar.saveFailed': 'The setting could not be saved.',
  'calendar.refresh': 'Read again at most every',
  'calendar.refresh.hint': 'Nothing is fetched while nobody is looking: this is how old the agenda may be when you look.',
  'calendar.horizon': 'The agenda looks ahead',
  'calendar.horizon.hint': 'How far the tile and the panel list events.',
  'calendar.minutes': '{n} minutes',
  'calendar.days.one': '{n} day',
  'calendar.days': '{n} days',
  'calendar.agenda.empty': 'Nothing scheduled.',
  'calendar.agenda.notConfigured': 'Sync this calendar to see the agenda here.',
  'calendar.agenda.configure': 'Configure',
  'calendar.agenda.join': 'Join',
  'calendar.agenda.now': 'now',
  'calendar.agenda.allDay': 'all day',
  'calendar.agenda.syncedAt': 'as of {time}',
  'calendar.agenda.refresh': 'Read the calendar again',
  'calendar.agenda.today': 'Today',
  'calendar.agenda.tomorrow': 'Tomorrow',
  'calendar.preview.notOpen': 'Open the tab to preview it.',
  'calendar.preview.loading': 'Loading preview…',
  'calendar.preview.unavailable': 'Preview unavailable.',
  'calendar.preview.alt': 'Preview of the open calendar tab',
  ...
  'settings.org.guide.title': 'Project collaboration',
  'settings.org.guide.accessTitle': 'Access the project.',
  'settings.org.guide.authorizeTitle': 'Authorize this computer.',
  'settings.org.guide.browser': 'Share the project with an existing person or device so its visible tasks open in their browser with the chosen content level.',
  'settings.org.guide.machine': 'Choose the collaborator’s connected computer and grant Agent Start for that project, model, effort and duration. Remote accounts and third-party sign-in are not automatic prerequisites.',
  'settings.org.guide.statePerson': 'Person present',
  'settings.org.guide.stateDevice': 'Device connected',
  'settings.org.guide.stateShared': 'Project shared',
  'settings.org.guide.stateStart': 'Agent Start authorized',
  'settings.org.guide.todoPerson': 'Add the collaborator',
  'settings.org.guide.todoDevice': 'Connect their device',
  'settings.org.guide.todoShared': 'Share the project',
  'settings.org.guide.todoStart': 'Authorize Agent Start',
  'settings.org.guide.ownership': 'The installation remains the project owner. These steps grant confined collaboration; they do not transfer ownership.',
  'settings.org.guide.copyLink': 'Copy installation link',
  'settings.org.guide.linkCopied': 'Installation link copied',
  'settings.org.guide.pairing': 'Open this link on the collaborator’s computer. The installation owner verifies its pairing code; after approval, that computer opens the confined guest view. This does not use Google, an OTP or an anonymous share link.',
  ...
  'board.checksFloor.title': 'Memory for the checks',
  'board.checksFloor.field': 'Free memory required (GB)',
  'board.checksFloor.hint': 'A delivery check starts only if the machine has had at least this much free memory for 2 minutes. The most expensive command measured here is lint from cold: 1.9 GB. At 0 the brake is off.',
  'board.checksFloor.off': 'Brake off: the checks start straight away, whatever the free memory.',
  'board.dispatch.brake': 'How the cap is decided',
  'board.dispatch.brakeCount': 'By count',
  'board.dispatch.brakeResources': 'By resources',
  'board.dispatch.runningResources': '{running} agents working',
  'board.dispatch.resourcesHint': 'The share is taken from what the rest of the machine leaves free: processes that are not Topics come first. A new agent starts only if it fits too.',
  'board.dispatch.budget': 'Topics share',
  'board.dispatch.budgetOfFree': '{pct}% of what is free',
  'board.dispatch.liveFree': 'Topics is using {used} of the {usable} cores it may take',
  'board.dispatch.howItWorks': 'How it works',
  'board.gauge.budgetLine': 'Topics is using {pct}% of the available CPU',
  'board.dispatch.budgetHint': 'On an idle machine: {units} core-units and {mem} GB of RAM on {cores} cores.',
  'board.gauge.frozen': '{n} checks frozen for load: they resume by themselves',
  'board.dispatch.liveLoading': 'Reading the machine...',
  'board.dispatch.verdictGo': 'a new agent would start',
  'board.dispatch.liveFreePending': 'Topics is using {used} of the {usable} cores it may take ({n} just started)',
  'board.dispatch.liveFreePendingOne': 'Topics is using {used} of the {usable} cores it may take (1 just started)',
  // The wait sentences: ONLY percentages of the whole Mac, never
  // cores/core-units/load. The resume threshold shows only when it is honest
  // from the gate's own numbers (`admissionVerdictText`); otherwise the
  // sentence stops after the current percentage, no invented target.
  'board.dispatch.verdictWaitCpu': 'Waiting: the Mac is at {pct}% CPU, it starts again by itself under {resume}%',
  'board.dispatch.verdictWaitCpuBare': 'Waiting: CPU is high, one more agent would cost {cost}%',
  'board.dispatch.verdictWaitCpuUnmeasured': 'Waiting: CPU is high',
  'board.dispatch.verdictWaitMemory': 'Waiting: the Mac is at {pct}% memory, it starts again by itself under {resume}%',
  'board.dispatch.verdictWaitMemoryBare': 'Waiting: the Mac is at {pct}% memory',
  'board.dispatch.verdictWaitMemoryUnmeasured': 'Waiting: memory is high (not measured on this Mac)',
  'board.dispatch.verdictWaitFloor': 'Waiting: {reason}',
  'board.dispatch.verdictWaitFloorBare': 'Waiting: the machine has no room, it starts again by itself once some frees up',
  'board.dispatch.verdictWaitDrain': 'Waiting: a server restart is on its way, it starts again by itself after',
  'board.dispatch.verdictFirst': 'the first one starts anyway',
  'board.filter.assignee': 'Assignee',
  'board.filter.person': 'Person',
  'board.filter.computer': 'Computer',
  'board.filter.initiator': 'Run initiator',
  'board.filter.runComputer': 'Execution computer',
  ...
  'board.gc.noAnswer': 'The GC did not answer',
  'board.plan.paneTitle': 'Plan',
  'board.projectPicker.noMatch': 'No project matches.',
  'board.projectPicker.none': 'No project found.',
  'board.projectPicker.create': 'Create “{name}”…',
  ...
  'board.label.originDerived': 'Derived from the delivery diff',
  'board.label.originAgent': 'Asked for by the agent',
  'board.label.originHuman': 'Set by hand',
  'board.reviewNotes.head.one': 'Diff review: 1 comment on {files} file.',
  'board.reviewNotes.head.many': 'Diff review: {n} comments on {files} files.',
  'board.reviewNotes.removedLine': '(removed line, numbering as it was)',
  'board.reviewNotes.footer': 'Answer point by point, with a change or with the reason it stays as it is. Then commit and put the task back in review.',
  'board.choice.archiveRunning.title': 'Archive a task in flight?',
  'board.choice.archiveRunning.confirm': 'Archive and stop',
  'board.choice.archiveRunning.body': 'An agent is working on this task: archiving it cuts its turn, and the turn does not come back.',
  'board.choice.deliverNow.message': 'Deliver now what you have: close with what is already done, write a summary comment and put the task in review.',
  'board.choice.failed': '{what} did not go through',
  'board.dispatch.queued': 'queued',
  'board.dispatch.waiting': 'put off',
  'board.dispatch.waiting.title': 'Waiting on an external condition: the slot is free, it starts again by itself',
  'board.dispatch.starting': 'starting…',
  'board.dispatch.working': 'working',
  'board.dispatch.needsInput': 'needs you',
  'board.dispatch.delivered': 'delivered',
  'board.dispatch.delivered.title': 'The agent delivered: it is waiting for your review',
  'board.dispatch.deliveredBySystem': 'run over',
  'board.dispatch.deliveredBySystem.title': 'I moved it to review, the agent did not deliver it. Read the thread before you judge it',
  'board.dispatch.deliveredEmpty': 'nothing to see',
  'board.dispatch.deliveredEmpty.title': 'No branch, no commit, no file touched: there is no diff to look at',
  'board.dispatch.failed': 'failed',
  'board.dispatch.blocked': 'needs fixing',
  'board.dispatch.stopped': 'stopped',
  'board.dispatch.waitedOut': 'waited out',
  'board.systemDelivery.retriesExhausted': 'The agent ran out of attempts without putting it in review itself: there may be no deliverable under it. Sending it back restarts the same session.',
  'board.systemDelivery.modelRefused': 'The model refused to go on: no automatic retry can unblock it. It takes a decision from you: sending it back unchanged would get the same refusal.',
  'board.systemDelivery.fanout': 'Fan-out: several agents worked the same task in parallel, each in its own worktree. Pick which attempt to keep from the Attempts panel. The others are thrown away.',
  'board.systemDelivery.parkedChildren': 'It is not a block, it is a question: the only open subtasks are parked in backlog, where no dispatcher picks them up. Answer with the two buttons and the task starts again by itself.',
  'board.systemDelivery.unknown': 'The agent did not deliver this: the system moved it at the end of the turn. There may be no deliverable under it. Read the thread before you open the diff.',
  'board.systemDelivery.chip.retriesExhausted': 'turns spent',
  'board.systemDelivery.chip.modelRefused': 'agent stuck',
  'board.systemDelivery.chip.fanout': 'pick the attempt',
  'board.systemDelivery.chip.parkedChildren': 'parked subtasks',
  'board.systemDelivery.chip.unknown': 'moved by the system',
  'board.blocked.on': 'waits on: {what}',
  'board.blocked.onTitle': 'This card waits on “{what}”: it does not start until that one closes.',
  'board.blocked.unknown': 'waits on another task',
  'board.blocked.unknownTitle': 'This card waits on another task: it does not start until that one closes. The title is not available here.',
  'board.waitingOnThis.one': '1 waits on it',
  'board.waitingOnThis.oneTitle': 'One task waits on this card: it starts by itself when you close it.',
  'board.waitingOnThis.many': '{n} wait on it',
  'board.waitingOnThis.manyTitle': '{n} tasks wait on this card: they start by themselves when you close it.',
  'board.subtaskWork.unattended': 'nobody is working it',
  'board.subtaskWork.unattendedTitle': 'In progress, but with no agent of its own and no ancestor at work: it stayed here. Put it back in the queue or close it.',
  'board.subtaskWork.parentTurn': 'in the parent turn',
  'board.subtaskWork.parentTurnTitle': 'Worked by the agent of: {what}',
  'board.reopened.label': 'reopened',
  'board.reopened.byYou': 'by you',
  'board.reopened.bySystem': 'by the system',
  'board.reopened.byAgent': 'by an agent',
  'board.reopened.byNamedAgent': 'by an agent ({who})',
  'board.reopened.detail': '{who} on {when}',
  'board.reopened.title': 'It had delivered: reopened {detail}. The reason is in the card thread.',
  ...
  'board.load.usage': 'Topics is using {pct}% of the Mac CPU',
  'board.load.machineBusy': 'The Mac is at {pct}% CPU: each extra agent slows the others down too.',
  'board.load.advice': 'It is a suggestion, not a cap: the real limit lives in the board settings.',
  ...
  'board.gauge.modeResources': 'Share: {pct}% of what is free',
  'board.gauge.derived': 'derived from the machine ({cores}) → cap {limit}',
  'board.gauge.spendToday': 'spent in the last 24h {amount}',
  'board.gauge.byResources': 'on budget',
  'board.gauge.wait.cpu': 'waiting: CPU',
  'board.gauge.wait.memory': 'waiting: memory',
  'board.gauge.wait.floor': 'stopped: no room',
  'board.gauge.wait.drain': 'stopped: restart',
  'board.gauge.memLine': 'memory: Topics holds {ours} GB, {free} GB free for Topics, one agent asks {cost}',
  'board.gauge.ariaResources': '{running} agents working, using {pct}% of the available CPU',
  'board.gauge.settings': 'Settings',
  // The two big percentages in the popover: CPU and memory for the whole Mac,
  // never Topics' private core budget.
  'board.gauge.cpuLabel': 'CPU',
  'board.gauge.memLabel': 'Memory',
  'board.gauge.notMeasured': 'not measured',
  'board.gauge.agentsOfMax': 'Agents working {running} / max {max}',
  'board.gauge.agentsNoLimit': 'Agents working {running}, no cap',
  'board.gauge.agentsPlain': 'Agents working {running}',
  'board.gauge.details': 'Details',
  ...
  'board.orchestrator.popOut': 'Open in a tab',
  ...
  'board.composer.modelAutoTitle': 'Follows the project choice. With Auto, Topics selects among connected, available models compatible with the task, across all providers.',
  'board.composer.modelAutoChip': 'Auto model',
  'board.composer.modelAuto': 'Auto (project default)',
  'board.composer.modelAutoOptionTitle': 'Follows the project choice; with Auto, selects among all connected providers compatible with the task',
  ...
  'chat.turnError.details': 'Technical details',
  'chat.turnError.copy': 'Copy the details',
  'chat.turnError.detailsTruncated': 'Technical details (payload stored truncated)',
  ...
  'runtime.topics': 'Topics (native, Claude only)',
  'runtime.cli': 'CLI (one process per session)',
  'runtime.jcode': 'jcode (shared daemon)',
  'runtime.blurb': 'Topics runs Claude agents natively in the server using credentials from an existing Claude login. Connecting a chat API key does not configure that login. GPT tasks require the Codex runtime; selecting Topics does not replace it.',
  ...
  'runtime.defaultUnavailable': 'The native Claude runtime is unavailable on this server. Check the Claude login and restart the server after setup. Agents use the CLI runtime when available.',
  ...
  'devices.guest': 'guest',
  'devices.guestTitle': 'Sees only what was shared with them, at the level chosen per card',
  ...
  'git.files.binaryTitle': 'Binary file: git does not count lines',
  'git.files.countsTitle': '{add} added, {del} removed',
  'git.files.loading': 'reading files…',
  ...
  'usage.range.all': 'All',
  'usage.readAt': 'read at {time}',
  'usage.failed': 'The figure did not arrive. Reopen the panel to try again.',
  'usage.none': 'Nothing consumed in this window.',
  'usage.colProject': 'Project',
  'usage.colTokens': 'Tokens',
  'usage.colCost': 'Cost',
  'usage.more': 'and {n} more below the line',
  'usage.costFloor': 'The cost is a floor: {tokens} tokens out of {total} are board work, which carries no input/output split and cannot be priced.',
  'usage.unpricedModels': 'Also unpriced: {models}.',
  'usage.rowChats': 'Chats: {tokens} tokens across {n} messages',
  'usage.rowTasks': 'Board: {tokens} tokens across {n} tasks (unpriceable)',
  'usage.rowUnpriced': '{n} messages carry a cost recorded before the cache split: left out of the money.',
  'usage.perProject': 'Usage by project',
  'perf.q1': 'Is it fast?',
  'perf.q2': 'What does it cost?',
  'perf.fpsAvg': 'fps · avg {n}',
  'perf.procCount': '{n} processes',
  'perf.inventory.heldHeading': 'Held (counts, not MB)',
  'perf.inventory.sessionsNoProject': 'Sessions with no project',
  'perf.inventory.includesSessions': '(includes the sessions)',
  'perf.inventory.insideBridge': '(inside the bridge)',
  'perf.inventory.insideApp': "(inside «The app»)",
  'perf.inventory.outsideTotal': '(outside the total)',
  'perf.sampling': 'sampling…',
  'perf.partialReading': 'partial reading',
  ...
  'browser.dev.width': 'Width in pixels',
  'browser.dev.height': 'Height in pixels',
  ...
  'statusBar.providerHold.heading': 'Claude limit reached',
  'statusBar.providerHold.fiveHours': 'Five-hour usage window.',
  'statusBar.providerHold.week': 'Claude weekly plan limit.',
  'statusBar.providerHold.reset': 'Reset: {date}',
  'statusBar.providerHold.unknownReset': 'time unavailable',
  'statusBar.providerHold.queuePaused': 'Claude tasks are waiting for the reset. Tasks using other providers can continue.',
  'statusBar.providerHold.otherChats': 'To continue in a new chat, you can choose another provider.',
  'statusBar.providerHold.manage': 'Manage AI providers',
  'statusBar.planUsage.heading': 'Claude usage: {pct}%',
  'statusBar.planUsage.remaining': 'The remaining quota is shared by Claude chats and agents.',
  ...
  'statusBar.agents.finishedHeading': 'Turn ended, to look at',
  ...
  'share.levelNotChosenHere': 'Sharing here conveys viewing only: levels are chosen on cards.',
  'share.levelFromContainer': 'This access comes from the project. Remove it from the project panel.',
  'share.viaProject': 'from the project',
  'share.agentStart.title': 'Agent Start',
  'share.agentStart.blurb': 'Separate authorization to start one agent on this project with a fixed execution policy.',
  'share.agentStart.add': 'Authorize',
  'share.agentStart.subject': 'Who',
  'share.agentStart.computer': 'Computer',
  'share.agentStart.model': 'Model',
  'share.agentStart.chooseModel': 'Choose a model',
  'share.agentStart.noVerifiedModels': 'No verified models',
  'share.agentStart.modelUnavailable': 'Model unavailable',
  'share.agentStart.modelUnverified': 'Node support not verified',
  'share.agentStart.remoteModelsUnverified': 'This remote node has not reported its supported models, so a new authorization cannot be created yet.',
  'share.agentStart.effort': 'Effort',
  'share.agentStart.duration': 'Maximum duration',
  'share.agentStart.minutes': '{n} min',
  'share.agentStart.repository': 'Repository mapping: {repository}',
  'share.agentStart.confirm': 'I confirm this person may start one agent at a time on this project and computer, with this policy.',
  'share.agentStart.policyNote': 'One attempt, no retries or fanout. Board holds and stricter limits still apply.',
  'share.agentStart.confirmAction': 'Confirm authorization',
  'share.agentStart.revokeFor': 'Revoke Agent Start for {name}',
  'share.agentStart.loadFailed': 'Could not load Agent Start authorizations.',
  'share.agentStart.saveFailed': 'Could not authorize Agent Start. Check the computer and repository mapping.',
  'share.agentStart.revokeFailed': 'Could not revoke Agent Start. Try again.',
  'share.agentStart.remoteState.pending': 'Waiting for approval on the remote computer',
  'share.agentStart.remoteState.approved': 'Approved, finishing the connection',
  'share.agentStart.remoteState.active': 'Remote computer authorized',
  'share.agentStart.remoteState.denied': 'Request denied',
  'share.agentStart.remoteState.expired': 'Request expired',
  'share.agentStart.remoteState.revoked': 'Authorization revoked',
  'share.agentStart.remoteState.failed': 'Connection not completed',
  'share.agentStart.remoteStatusNote': 'The code is only for matching the request; no credential is shown in the browser.',
  'share.agentStart.remoteReissue': 'Generate a new code',
  'share.agentStart.remoteRequestRevoke': 'Revoke remote connection',
  'share.agentStart.remoteRequestFailed': 'Could not generate a new code. Try again.',
  'share.agentStart.remoteRevokeFailed': 'Remote revocation was not completed. Try again.',
  'share.agentStart.verifyComputer': 'Verify computer',
  'share.agentStart.catalogNote': 'First verify the checkout and available models on this computer. This step does not grant Agent Start.',
  'share.agentStart.catalogFailed': 'Could not start computer verification. Try again.',
  'share.agentStart.catalogState.pending': 'Waiting for verification on the remote computer',
  'share.agentStart.catalogState.approved': 'Verification approved, reading the catalog',
  'share.agentStart.catalogState.active': 'Catalog verified, no models available',
  'share.agentStart.catalogState.denied': 'Verification denied',
  'share.agentStart.catalogState.expired': 'Verification expired',
  'share.agentStart.catalogState.revoked': 'Verification revoked',
  'share.agentStart.catalogState.failed': 'Verification not completed',
  'board.card.runInitiator': 'Started by {name}',
  'board.card.runInitiatorTitle': '{name} requested this delegated run',
  'board.card.runComputerTitle': 'Delegated run executed on {name}',
  ...
  'board.queue.nodeUnreachable.head': 'node silent',
  'board.queue.nodeUnreachable.detail': '{node} is not answering',
  'board.queue.nodeUnreachable.title': 'This card has to run on the node {node}, and the node is not answering. It waits in the queue until it comes back: it never starts here, because a machine being off is not a reason to run the work somewhere else.',
  ...
  'board.queue.planWindow.head': 'waiting',
  'board.queue.planWindow.detail': 'plan window nearly full',
  'board.queue.planWindow.title': "The subscription's five-hour window is nearly spent, so no new card starts: what is left goes to the turns already running and to your own chats. It resumes by itself at the reset, with nothing for you to do. {reason}",
