...
const EN = {
  ...
  'board.gauge.budgetLine': '{running} agents, using {used} of the {usable} cores Topics may take',
  ...
  'board.dispatch.verdictWaitCpu': 'new ones wait: CPU, one agent costs {cost} cores',
  'board.dispatch.verdictWaitCpuResume': 'new ones wait: CPU, restarting under {resume} cores',
  'board.dispatch.verdictWaitMemory': 'new ones wait: memory, {cost} GB needed, {free} GB free for Topics',
  'board.dispatch.verdictWaitMemoryFootprint': 'new ones wait: memory, Topics holds {ours} GB against a ceiling of {ceiling} GB',
  'board.dispatch.verdictWaitMemoryBare': 'new ones wait: memory',
  'board.dispatch.verdictWaitFloor': 'new ones wait: {reason}',
  'board.dispatch.verdictWaitFloorBare': 'new ones wait: the machine has no room',
  'board.dispatch.verdictWaitDrain': 'new ones wait: a server restart is on its way',
  ...
  'board.gauge.ariaResources': '{running} agents working, using {used} of the {usable} cores Topics may take',
