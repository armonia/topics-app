...
const EN = {
  ...
  'board.filter.priorityAssignee': 'Priority & assignee',
  'board.filter.priorityAssigneePlaceholder': 'priority, @assignee…',
  'board.filter.priorityAssigneeLabel': 'Filter by priority or assignee',
  ...
  'statusBar.orgs.more': '{n} more organizations',
