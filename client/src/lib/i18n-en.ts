...
const EN = {
  ...
  'ai.advanced.title': 'Advanced · agent execution',
  'ai.advanced.hint': 'Runtimes, local programs, MCP tools and checkpoints. The native Topics engine currently supports Claude only; GPT tasks require Codex.',
  ...
  'statusBar.providerHold.queuePaused': 'Automatic task starts are waiting for the reset.',
