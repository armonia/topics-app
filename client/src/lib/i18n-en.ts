...
const EN = {
  ...
  'browser.tab.kind.heavy': 'High CPU: {cpu}% of a core. Pauses when you leave this tab',
  'browser.tab.kind.heavyPaused': 'Paused to save CPU',
  'browser.heavy.paused.title': 'Paused',
  'browser.heavy.paused.body': 'This page was using {cpu}% of a CPU core. It picks up where it was when you select it.',
  ...
  'swapFreeze.label': 'Frozen: {command}, {gb} GB, Mac swapping',
  'swapFreeze.title': 'Topics stopped it because the Mac was reading {rate} pages per second back from disk. It resumes on its own within 10 minutes, or sooner if memory frees up. A test or a request with a timeout in flight can expire on resume.',
  'swapFreeze.frozenShort': 'frozen',
