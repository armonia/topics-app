...
const EN = {
  ...
  'goal.loop.stalled': 'Goal: auto-continuation paused, nothing was moving. It resumes at your next message',
  ...
  'chat.command.modelSet': 'Model set: {model}',
  'chat.command.effortSet': 'Effort set: {level}',
