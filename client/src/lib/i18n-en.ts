...
const EN = {
  ...
  'board.dispatch.liveFree': '{used} of {usable} cores available',
  'board.dispatch.howItWorks': 'How it works',
  'board.gauge.budgetLine': '{running} agents, {used} of {usable} cores available',
  ...
  'board.gauge.ariaResources': '{running} agents working, {used} of {usable} cores available',
