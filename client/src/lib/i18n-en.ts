...
const EN = {
  ...
  'background.notice.deferred.autonomy': 'The autonomy change applies from the first message after the background work ends',
  'background.notice.deferred.model': 'The model change applies from the first message after the background work ends',
  'background.notice.deferred.effort': 'The effort change applies from the first message after the background work ends',
  ...
  'board.night.load': 'How busy the Mac is',
  ...
  'board.checksFloor.fold': 'Advanced: room for the checks',
  ...
  'board.dispatch.resourcesHint': 'Topics takes its share of what the other programs on the Mac leave free: they come first. A new agent starts only if it fits too.',
  'board.dispatch.budget': 'How much Topics may use',
  'board.dispatch.budgetOfFree': 'up to {pctAl} of the free Mac',
  'board.dispatch.liveFree': 'Topics is using {usedIl} of the Mac, it may go up to {ceilAl}',
  'board.dispatch.howItWorks': 'How it works',
  'board.gauge.budgetLine': 'Topics is using {usedIl} of the Mac, it may go up to {ceilAl}',
  ...
  'board.dispatch.liveFreePending': 'Topics is using {usedIl} of the Mac, it may go up to {ceilAl} ({n} just started)',
  'board.dispatch.liveFreePendingOne': 'Topics is using {usedIl} of the Mac, it may go up to {ceilAl} (1 just started)',
  ...
  'board.dispatch.verdictWaitFloor': 'Waiting: the Mac is almost full, starts again by itself once room frees up',
  'board.dispatch.verdictWaitFloorBare': 'Waiting: the Mac is almost full, starts again by itself once room frees up',
  ...
  'board.gauge.modeResources': 'Share: up to {pctAl} of the free Mac',
  ...
  'board.gauge.wait.cpu': 'waiting: Mac busy',
  'board.gauge.wait.memory': 'waiting: Mac busy',
  ...
  'board.gauge.ariaResources': '{running} agents working, Topics is using {pctIl} of the Mac',
  ...
  'board.gauge.agentsOfMax': '{running} agents working, max {max}',
  'board.gauge.agentsNoLimit': '{running} agents working, no cap',
  'board.gauge.agentsPlain': '{running} agents working',
  'board.gauge.details': 'Details',
  // THE ONE NUMBER (24/09): how busy the whole Mac is, the larger of CPU%
  // and memory%. {pctAl}/{pctIl} carry the number WITH its article, so the
  // Italian elides where it must ("all'88%", "l'11%"): see `pctWith`.
  'machine.busy': 'The Mac is {pctAl} busy',
  'machine.busyUnknown': 'How busy the Mac is cannot be measured',
  ...
  'chat.machineStop.superseded': "Stopped: the card's work has already landed or moved elsewhere",
  ...
  'statusBar.load.calmo': 'The Mac is {pctAl} busy: all quiet',
  'statusBar.load.caldo': 'The Mac is {pctAl} busy: warming up',
  'statusBar.load.carico': 'The Mac is {pctAl} busy: it is loaded',
  'statusBar.load.unknown': 'How busy the Mac is cannot be measured from here: only the desktop app sees it.',
  ...
  'board.queue.resourcePressure.title': 'The cap is set by resources and the Mac is busier than the share you chose, so no new agent starts. It restarts on its own as soon as the Mac frees up, and you can move the share in the board settings. {reason}',
