...
const EN = {
  ...
  'task.model.hint': 'The agent model. Auto selects an available coding agent.',
  'task.model.sessionFixed': 'The model is fixed to the session already assigned to this task.',
