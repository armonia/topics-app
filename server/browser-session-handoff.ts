 ...
 *    non nasce.
 *
 * DIREZIONE. Solo nativa → condivisa. Il ritorno (il telefono si logga sulla
 * sessione condivisa e il Mac torna nativo) scriverebbe nel barattolo
 * persistente del Mac, che è un'altra decisione e un altro rischio: qui non si
 * fa.
 */
import {
