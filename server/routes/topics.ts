...
import { blocksForDisk, leanMessagesForWire, rowHasBlocks, toolCallsColumnForRow } from "../../shared/lean-tool-call";
    ...
    if (method === "POST" && pathname === "/api/test/seed-message") {
      ...
      try {
        ...
        `).run({
          ...
          $tool_calls: toolCallsColumnForRow(body.toolCalls, rowHasBlocks(body.blocks)),
