...
**Purpose:** Specifies behavioral scenarios for the context inspector, token budget management, context source toggling, context pills in chat input, and topic-level and global memory CRUD operations.
...
### CTX-01: Inspector, Budget Bar, Source Toggle & Memory CRUD
